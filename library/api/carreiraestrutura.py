...
from library.models import CarreiraEstrutura


log = getLogger(__name__)


class MPECarreiraEstrutura(RestfulDRY):

    _model = CarreiraEstrutura
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("library.CarreiraEstrutura.Manage")')
