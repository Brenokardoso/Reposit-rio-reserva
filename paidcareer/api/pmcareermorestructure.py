...
from paidcareer.models import PMCareerMoreStructure


log = getLogger(__name__)


class LRYPMCareerMoreStructure(RestfulDRY):

    _model = PMCareerMoreStructure
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("paidcareer.careerandstructure.Manage")')
