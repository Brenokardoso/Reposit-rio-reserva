 ...
 *
 **/
 Ext._define('transparency.people_management.assigned_employees.PMLoadDataWindow', {
    ...
    assignedFromTo: function() {
        if(!this._fromToField) {
            this._fromToField = new Ext.form.ComboBox({
                fieldLabel: 'Cedidos pelo/para (o) MP',
                hiddenName: 'from_to',
                width: 175,
                store: [
                    [1, 'TODOS'],
    ...
    _toSave: function() {
        var rest = Ext._create('transparency.people_management.assigned_employees.Restful');
    ...
    constructor: function(cfg) {
        ...
        transparency.people_management.assigned_employees.PMLoadDataWindow.superclass.constructor.call(this, cfg);
    },
});
