 ...
 *
 **/
 Ext._define('transparency.people_management.employees_members.PMLoadDataWindow', {
    ...
    getSituation: function() {
        if (!this._situationField) {
            this._situationField = new Ext.form.ComboBox({
                fieldLabel: 'Situação',
                hiddenName: 'situacao',
                width: 175,
                store: [
    ...
    _toSave: function() {
        var rest = Ext._create('transparency.people_management.employees_members.Restful');
    ...
    constructor: function(cfg) {
        ...
        transparency.people_management.employees_members.PMLoadDataWindow.superclass.constructor.call(this, cfg);
    },
});
